...
class PPOBuffer:
    ...
    def __init__(self, obs_dim, info_dim, act_dim, size, device, gamma=0.99, lam=0.95):
    ...
    def get(self):
        ...
        data = dict(obs=self.obs_buf, info=self.info_buf, act=self.act_buf, ret=self.ret_buf,
